...
public:
    ...
    OptimizedStatusRscManager &operator=(const OptimizedStatusRscManager &) = delete;
...
inline int OptimizedStatusRscManager::getNextProbe(int current_pos, int step, uint32_t hash2_val) const {
    // 双重哈希探测
